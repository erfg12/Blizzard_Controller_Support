    ...
    public partial class mainform : Form
    {
        ...
        private void UIStatus()
        {
            while (true)
            {
                ...
                // prevent BG worker loops from breaking and stopping
                if (!joysticksBGW.IsBusy)
                    joysticksBGW.RunWorkerAsync();
                if (!buttonPressesBGW.IsBusy)
                    buttonPressesBGW.RunWorkerAsync();
